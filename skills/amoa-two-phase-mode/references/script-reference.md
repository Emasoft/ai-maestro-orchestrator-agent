...
- **4.1 amoa_init_design_folders.py** - Initialize design folder structure
  ...
  - Usage: `python3 amoa_init_design_folders.py --platforms web ios android`

- **4.2 amoa_compile_handoff.py** - Compile handoff document for agent
  ...
  - Usage: `python3 amoa_compile_handoff.py auth-core implementer-1 --platform web`

- **4.3 amoa_design_search.py** - Search design documents
  - Search by UUID, type, status, or keyword
  - Supports all design/*/ subfolders
  - Returns structured results
  - Usage: `python3 amoa_design_search.py --keyword "auth" --type requirements`

- **4.4 amoa_sync_kanban.py** - Sync modules with GitHub Projects kanban
  ...
  - Usage: `python3 amoa_sync_kanban.py --project-id PVT_kwDOBxxxxxx --create-missing`

- **4.5 amoa_create_module_issues.py** - Create GitHub issues for modules
  - Reads module specifications from state file
  - Creates GitHub issue for each module
  - Updates module with issue number
  - Usage: `python3 amoa_create_module_issues.py --all --project-id PVT_kwDOBxxxxxx`
