...
- [label-categories-detailed.md](./references/label-categories-detailed.md)
  <!-- TOC: Assignment Labels (`assign:*`) | Rules | Assignment Authority | Conflict Resolution | Status Labels (`status:*`) | Status Workflow | Priority Labels (`priority:*`) | Type Labels (`type:*`) | Component Labels (`component:*`) | Effort Labels (`effort:*`) | Platform Labels (`platform:*`) | Toolchain Labels (`toolchain:*`) | Review Labels (`review:*`) -->
